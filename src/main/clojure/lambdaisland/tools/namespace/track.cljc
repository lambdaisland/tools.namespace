...
(ns ^{:author "Stuart Sierra"
  ...
  (:require [clojure.set :as set]
            [lambdaisland.tools.namespace.dependency :as dep]))
...
(comment
  ...
  {;; Dependency graph of namespace names (symbols) as defined in
   ;; lambdaisland.tools.namespace.dependency/graph
   :lambdaisland.tools.namespace.track/deps {}
   ...
   ;; Added by lambdaisland.tools.namespace.file: Map from source files
   ...
   :lambdaisland.tools.namespace.dir/files #{}

   ;; Added by lambdaisland.tools.namespace.dir: Instant when the
   ;; directories were last scanned, as returned by
   ;; System/currentTimeMillis.
   :lambdaisland.tools.namespace.dir/time 1405201862262})
